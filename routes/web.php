<?php
    ...
    use App\Http\Controllers\FleetcontgractController;
    use App\Http\Controllers\AccessoriesController;
    use App\Http\Controllers\VehicleController;
    use App\Http\Controllers\ModelsController;
    use App\Http\Controllers\VcateoriesController;
...
// Backend section start
    ...
    Route::group(['prefix' => '/admin', 'middleware' => ['auth', 'admin']], function () {
        ...
        Route::resource('stockpicking', 'StockpickingController');

        Route::resource('contracts', 'ContractsController');

        Route::resource('fleetcontracts', 'FleetcontgractController');
        Route::resource('accessories', 'AccessoriesController');
        Route::resource('vehicles', 'VehicleController');
        Route::resource('models', 'ModelsController');
        Route::resource('vcateories', 'VcateoriesController');
